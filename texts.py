...
def _announce_concert() -> str:
    """Анонс-приветствие для НОВЫХ пользователей на /start («Стендап за ужином», 11 июля)."""
    return (
        "<b>Мы возвращаемся!</b>\n\n"
        "🗓 <b>11 ИЮЛЯ | СУББОТА</b>\n\n"
        "🎙 Шоу «Стендап за ужином» – проверенные шутки от опытных комиков, "
        "гостеприимный ресторан, вкусные блюда, крутой фотограф.\n\n"
        "🕖 Сбор гостей: 19:00\n"
        "💵 Вход: 200 000 VND при оплате онлайн · 300 000 VND при оплате на месте\n"
        "📍 Место: <a href=\"https://maps.app.goo.gl/n5qxL5DpodLqbbAH8\">"
        "Ресторан грузинской кухни KINZADZA</a> 🌶\n\n"
