...
def _announce_concert() -> str:
    """Анонс платного стендап-концерта «Стендап за ужином» (11 июля)."""
    map_line = f"\n🗺 <a href=\"{config.EVENT_MAP_URL}\">Как добраться</a>" if config.EVENT_MAP_URL else ""
    return (
        "Привет! 👋\n\n"
        "Это бот регистрации на <b>«Стендап за ужином»</b> –\n"
        "вечер живого юмора в грузинском ресторане «Кинзадза» в Нячанге.\n\n"
